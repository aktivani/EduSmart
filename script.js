document.addEventListener('DOMContentLoaded', function() {
    // Quiz data - 10 questions per subject
    const quizData = {
        math: [
            {
    ...
    // Start quiz when subject is selected
    ...
    function startQuiz() {
        ...
        score = 0;
        questions = [...quizData[currentSubject]]; // Create a copy of questions
    ...
    function retakeQuiz() {
        // Close popup and restart quiz
        resultPopup.style.display = 'none';
        startQuiz();
    }

    function viewResources() {
        // Redirect to resources page for the subject
